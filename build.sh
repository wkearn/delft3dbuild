...
case $compiler in
    gnu)
        ...
        addpath LD_LIBRARY_PATH /usr/lib /usr/lib
...
if [ "$compiler" = 'gnu' ]; then
    addpath PATH /usr/bin
    export MPI_INCLUDE=/opt/mpich-3.2-install/include
    export MPILIBS_ADDITIONAL="-L/opt/mpich-3.2-install/lib -lfmpich -lmpich -lmpl"
    # export MPILIBS_ADDITIONAL=" "
    export MPIFC=/opt/mpich-3.2-install/bin/mpif90
else
    # Intel compilers
